...
## Описание реализации
1. Создал класс TimeEntry
2. Создал класс Disbalance
3. В классе Main прописал основуню логику приложения:
   4. Прописана логика чтение и сохранения в файл
   5. Проводится подсчет общего количества списанных часов 
   6. Распределение дизбаланса по положительеым и отрицательным
    
## Инструкция по сборке и запуску решения
Для использования приложения достаточно клонировать репозиторий. 
Если используете Intellij IDEA достаточно открыть класс Main и запустить.
Результат будет лежать в текстовом файле result.txt

В случае использования командной строки пропишите в командной строке javac Main.
Дальше нужно написать java Main.java и приложение выполнит свой функционал
